...
function Contact() {
  return (
    <section id="contact" className="py-20 bg-gray-100">
      <div className="max-w-6xl mx-auto px-0 md:px-3">{/* ✅ fixed left gap */}
        {/* Title */}
        <motion.h2
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          {/* Right - Contact Info */}
          <motion.div
            className="p-8 flex flex-col justify-between" // ✅ no background/shadow
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.6 }}
          >
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center space-x-4">
                ...
                <a href="tel:+923083152045" className="text-gray-700 text-blod">
                  +92 3083152045
                </a>
              </div>
